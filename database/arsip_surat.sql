...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2021 at 09:52 AM
...
(2, 'Bidang Kepegawaian dan Umum'),
(3, 'Bidang Kerja Sama dan Humas'),
(4, 'Bidang Kemahasiswaan');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_fa`
--
...
('asjkhakjsha', '641d85b4-c55a-41a1-a7a9-bcd78405fd6e', '2021-05-30 09:39:37');
...
--
-- Table structure for table `tbl_scan_sulur`
--
...
--
-- Dumping data for table `tbl_scan_sulur`
--

INSERT INTO `tbl_scan_sulur` (`id`, `id_sulur`, `path`, `tgl`, `deskripsi`) VALUES
(1042019164913, 5, '2021/01042019164913.png', '2021-04-01 14:49:13', 'halaman 1'),
(1042019164921, 5, '2021/01042019164921.jpg', '2021-04-01 14:49:21', 'halaman 2'),
(18052019164538, 7, '2021/18052019164538.PNG', '2021-05-18 14:45:38', 'halaman 1'),
(18052019164557, 7, '2021/18052019164557.jpg', '2021-05-18 14:45:57', 'halaman 2');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_scan_suma`
--
...
--
-- Dumping data for table `tbl_scan_suma`
--

INSERT INTO `tbl_scan_suma` (`id`, `id_suma`, `path`, `tgl`, `deskripsi`) VALUES
(1042019154716, 2, '2021/01042019154716.jpg', '2021-05-29 07:17:20', 'halaman 1'),
(1042019154741, 2, '2021/01042019154741.png', '2021-05-29 07:17:27', 'halaman 2'),
(18052019164806, 3, '2021/18052019164806.png', '2021-05-29 07:17:35', 'halaman 1'),
(18052019164818, 3, '2021/18052019164818.png', '2021-05-29 07:17:42', 'halaman disposisi');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_suma`
--
...
--
-- Dumping data for table `tbl_suma`
--
...
(1, '474.3/98', 'Dinas Pendidikan Dan Olahraga Kab. Kampar', 'Permintaan Data', '2021-03-30', '2021-03-30 02:33:16', 'Mohon DiProses', 1, '2021-03-29'),
(2, '363.7/121', 'Universitas Pahlawan', 'Undangan Rapat', '2021-03-30', '2021-03-30 03:49:41', 'Arsip/Simpan', 3, '2021-03-30'),
(3, '475.3/V/2021/0009', 'Politeknik Bengkalis', 'Permohonan Data Workshop', '2021-05-18', '2021-05-18 14:47:42', 'Berikan Sesuai Dengan Database', 2, '2021-05-18'),
(4, '123', 'Politeknik Kampar', 'Undangan Rapat', '2021-05-31', '2021-05-29 15:39:52', 'Mohon Diproses', 1, '2021-05-18'),
(5, '1234', 'Politeknik Kampar', 'Kerja Sama', '2021-05-30', '2021-05-30 07:37:12', 'Mohon di Proses', 3, '2021-05-29');
...
(3, 1, '464.9', 'Politeknik Caltex Riau', 'Undangan Seminar ', '2021-03-29', 1, '2021-03-29 13:09:06'),
(4, 2, '474.3/', 'Yayasan Datuk Tabano', 'Undangan Rapat', '2021-03-29', 3, '2021-03-29 13:45:37'),
(5, 3, '878.1/', 'Politeknik Bengkalis', 'Undangan Pertukaran Mahasiswa', '2021-03-29', 1, '2021-03-29 13:48:12'),
(7, 5, '474.2/2019/', 'Pegadaian Bangkinang', 'Permohonan Kerja Sama Magang', '2021-05-18', 3, '2021-05-18 14:45:04'),
(8, 2, '123', 'Dinas Olahraga', 'Undangan Rapat', '2021-05-02', 3, '2021-05-29 15:38:33'),
(9, 3, 'KB233', 'Politeknik Kampar', 'Undangan Seminar', '2021-05-29', 3, '2021-05-30 07:36:07');
...
('84fd4236-d58d-43fb-bb6c-e1d6cf96a617', 'user1', '202cb962ac59075b964b07152d234b70', 1, '2021-05-29 17:40:56', '0'),
('853d5e57-5836-41f8-a190-5555904aa049', 'melysa', '202cb962ac59075b964b07152d234b70', 1, '2021-05-30 09:38:13', '0'),
('asjkhakjsha', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '2021-10-10 00:00:00', '0'),
('b737b749-4592-4c1a-8938-10953f3a8a7c', 'pelayanan', '202cb962ac59075b964b07152d234b70', 2, '2021-05-18 16:42:39', '0'),
('df492639-977a-4ef6-bba8-4207de5eedb7', 'operator', '202cb962ac59075b964b07152d234b70', 2, '2021-12-15 05:48:02', '0');
...
('asjkhakjsha', 'Admin Melysa', 'anggitaranimelysa@gmail.com', 'Bangkinang', 'asjkhakjsha30_03_2019_03_53_19.jpg'),
...
(202, 'asjkhakjsha', '2021-05-28 17:31:29', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(203, 'asjkhakjsha', '2021-05-28 17:34:18', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'logout'),
(204, 'asjkhakjsha', '2021-05-28 17:34:28', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(205, 'asjkhakjsha', '2021-05-29 08:45:22', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(206, 'asjkhakjsha', '2021-05-29 08:49:34', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'logout'),
(207, 'asjkhakjsha', '2021-05-29 09:06:49', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(208, 'asjkhakjsha', '2021-05-29 09:49:33', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'logout'),
(209, 'asjkhakjsha', '2021-05-29 09:49:42', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(210, 'asjkhakjsha', '2021-05-29 14:22:21', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(211, 'asjkhakjsha', '2021-05-29 14:24:02', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'logout'),
(212, 'asjkhakjsha', '2021-05-29 14:24:16', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(213, 'asjkhakjsha', '2021-05-29 17:37:16', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(214, 'asjkhakjsha', '2021-05-29 17:42:41', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'logout'),
(215, 'asjkhakjsha', '2021-05-29 17:42:50', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(216, 'asjkhakjsha', '2021-05-29 17:42:55', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'logout'),
(217, 'asjkhakjsha', '2021-05-29 17:43:11', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(218, 'asjkhakjsha', '2021-05-29 17:47:48', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'logout'),
(219, 'asjkhakjsha', '2021-05-29 17:48:22', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login'),
(220, 'asjkhakjsha', '2021-05-30 09:34:26', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 0, 'login');
...
--
ALTER TABLE `tbl_suma`
  MODIFY `id_suma` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_surat_keluar`
--
ALTER TABLE `tbl_surat_keluar`
  MODIFY `id_sulur` bigint(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbl_user_log`
--
ALTER TABLE `tbl_user_log`
  MODIFY `number` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=221;
...
--
-- Constraints for table `tbl_online`
--
ALTER TABLE `tbl_online`
