...
<div class="wrapper">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-12 text-center">
                    <strong>Create by Melysaa</strong><br/>Show My <a target="_blank" href="https://github.com/Melysaa">Github</a> <!-- please dont change this --> <!-- hargai kami selaku pembuat aplikasi -->
                  </div>
                </div>
                <!-- /.row -->
              </li>
  ...
  <footer class="main-footer">
    ...
    <strong>SIM Surat Created By Melysa Anggita Rani</strong> <a href="https://github.com/Melysaa">Github</a>
